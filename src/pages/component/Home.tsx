...
import MainDashboard from "./DashboardHero";
...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="mx-1 h-screen flex justify-between items-center bg-slate-400">
        <div className=" bg-slate-100 w-[95%] mb-3 mx-auto mt-2 flex">
          {/* SIDE BAR */}
          <div className="bg-slate-600 text-white w-[200px] p-2 my-5 mx-6 rounded-lg ">
            ...
            <div className="flex items-center text-sm gap-3 font-medium mt-5 hover:bg-[#d2dad7] py-3 px-2 hover:text-[#344e6d] hover:rounded-lg">
